				...
				<form method="post" class="card shadow">
					...
					<div class="card-body">
						...
						<div class="form-group">
							...
							<select required name="flight" class="form-control">
						...
						<div class="form-group">
							...
							<select required name="hotel" class="form-control">
								...
								<option>Hotel Oberoi</option>
								<option>Great Villa</option>
								<option>Hotel Suhana</option>
							</select>
						</div>
						
						<div class="form-group">
							<label for="insurance">Travel Insurance</label>
							<input type="checkbox" id="insurance" class="form-check-inline" name="insurance" value="Y">
						</div>
